namespace CarRacing.Utilities.Messages
{
    public static class ExceptionMessages
    {
        ...
        public const string InvalidCarVINLength = "Car VIN must be exactly 17 characters long.";

        public const string InvalidCarVINNameNull = "Car VIN cannot be null or empty.";

        public const string InvalidCarHorsePower = "Horse power cannot be below 0.";

        public const string InvalidCarFuelAvailable = "Fuel available cannot be below 0.";
